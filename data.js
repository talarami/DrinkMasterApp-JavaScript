...
listOfDrinks.push(capeCod)
listOfDrinks.push(ginTonic)
listOfDrinks.push(sexOnTheBeach)
listOfDrinks.push(hotToddy)
listOfDrinks.push(whiskeySour)
listOfDrinks.push(blinker)
listOfDrinks.push(hugo)
listOfDrinks.push(limoncelloSpritz)
listOfDrinks.push(blueHawaii)
listOfDrinks.push(tequilaSunrise)
listOfDrinks.push(appleProseccoPunch)
listOfDrinks.push(easyMargarita)
listOfDrinks.push(sunriseMocktail)
listOfDrinks.push(virginMojito)
listOfDrinks.push(mimosaMocktail)
listOfDrinks.push(cinderellaMocktail)
